...
// import { startListSlots } from "../actions/slotsAction"
...
//                     return(
//                         <li key={slot._id}>
//                             <p>Date& Time: {startDateTimeIST}</p>
//                             <p>End Date& Time: {endDateTimeIST} </p>
//                             <p>Interval: {slot.interval}</p>
//                             <p>Status: {slots.isBooked ? 'Booked' : 'Available' } </p>

//                             {!slot.isBooked && (
//                                 <button onClick={() => handleBook(slot._id)} disabled={slot.isBooked}>
//                                     Book Appointment
//                                 </button>
//                             )}
//                         </li>
...
//                 })}     
//             </ul>
//             {selectedSlot && <Payment slotId={selectedSlot} />}
//         </div>
//     )
// }
